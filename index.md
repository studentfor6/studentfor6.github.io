...
<!-- SERVICE GRID -->
<section class="max-w-5xl mx-auto grid gap-6 px-4 
...
<!-- FEATURE GRID -->
<section class="max-w-5xl mx-auto mt-16 grid gap-6 px-4 
...
<section class="max-w-4xl mx-auto mt-20 px-4 text-center">
  ...
  <a href="./blog.html"
     class="inline-block px-6 py-3 rounded-lg bg-[#0f4d8a] text-white font-medium hover:bg-[#1c6ab6] transition">
    Visit the blog →
  </a>
</section>
...
<!-- CONTACT SECTION -->
<section class="max-w-4xl mx-auto mt-20 px-4 text-center mb-20">
